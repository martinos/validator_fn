...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Collection of lambdas to create validation for Ruby structures}
  spec.description   = %q{Collection of lambdas to create validation for Ruby structures}
